...
int main()
{
    ...
    SSLL<int>::iterator citer = list.begin();
    SSLL<int>::iterator cend = list.end();
    ...
    const SSLL <int> newlist = list;

    SSLL<int>::const_iterator  citer2 = newlist.begin();
    SSLL<int>::const_iterator cend2 = newlist.end();
