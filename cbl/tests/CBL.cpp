...
int main()
{
    ...
    CBL<int>::iterator citer = list.begin();
    CBL<int>::iterator cend = list.end();
    ...
    const CBL <int> newlist = list;

    CBL<int>::const_iterator  citer2 = newlist.begin();
    CBL<int>::const_iterator cend2 = newlist.end();
