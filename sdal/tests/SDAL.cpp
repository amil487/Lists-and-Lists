...
int main()
{
    ...
    std::cout << "current arraysize: " << list.atestsize() << std::endl;
    ...
    SDAL<int>::iterator citer = list.begin();
    SDAL<int>::iterator cend = list.end();
    ...
    const SDAL <int> newlist = list;

    SDAL<int>::const_iterator  citer2 = newlist.begin();
    SDAL<int>::const_iterator cend2 = newlist.end();
